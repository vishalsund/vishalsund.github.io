---
title: "an intro to brain computer interfaces"
date: 10-05-2025
description: 'Detecting imagined hand movement from EEG data'
---
...
![Brain diagram of the Motor Cortex](/img/bci/motor-cortex.jpg)
...
![Cortical homunculus](/img/bci/cortical-homunculus.jpg)
...
![Raw EEG signal](/img/bci/raw-eeg.png)
...
![PSD formula](/img/bci/psd-formula.png)
...
![PSD of the Theta Band](/img/bci/theta-band-psd.png)
![PSD of the Alpha Band](/img/bci/alpha-band-psd.png)
![PSD of the Beta Band](/img/bci/beta-band-psd.png)
...
![Logvariance of the Alpha Band](/img/bci/alpha-band-logvar.png)
...
![Log-variance after applying CSP](/img/bci/csp-logvar.png)
...
![PSD of the first, middle, and last feature of the CSP matrix](/img/bci/csp-psd.png)
...
![First Component](/img/bci/csp-1.png)

![Last Component](/img/bci/csp-59.png)
...
![Testing Scatterplot](/img/bci/test-scatterplot.png)

![Confusion Matrix](/img/bci/confusion%20matrix.png)
